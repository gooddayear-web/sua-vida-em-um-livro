...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Sua História em um Livro | Sua Vida em um Livro™",
    description:
      "Transformamos histórias de vida, memórias e trajetórias familiares em livros personalizados.",
...
export default function SuaHistoriaLandingPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#FDFBF7] selection:bg-[#B87333]/30 selection:text-white font-sans overflow-x-hidden pb-16 md:pb-0">
      ...
      <header className="fixed top-0 w-full z-50 bg-[#0a0a0a]/90 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          >
            ...
            <span className="text-[#B87333] text-sm align-super">™</span>
          </Link>
          ...
          <WhatsAppLink
            href={getWhatsAppUrl(
              "Olá! Gostaria de saber como transformar minha história em um livro.",
              "header"
            )}
      ...
      <main className="pt-20">
        ...
        <section className="relative min-h-[85vh] flex flex-col justify-center px-6 py-20">
          <div className="absolute inset-0 z-0 opacity-20">
            <div className="w-full h-full bg-gradient-to-b from-transparent to-[#0a0a0a] absolute inset-0 z-10" />
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 mt-6">
            ...
            <p className="text-white/70 text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed mb-6">
              Você viveu momentos que ninguém mais viveu. Nós transformamos
              suas memórias, experiências e acontecimentos em um livro feito
              para preservar quem você é e aquilo que não pode ser esquecido.
            </p>

            <p className="text-[#B87333] text-sm md:text-base font-serif italic mb-10">
              Você não precisa saber escrever. Você só precisa ter uma história
              para contar.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <WhatsAppLink
                href={getWhatsAppUrl(
                  "Olá! Conheci o Sua Vida em um Livro e quero transformar minha história em livro.",
                  "hero"
                )}
        ...
        <section className="py-20 px-6 bg-neutral-900/40 border-y border-white/5">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <span className="text-[#B87333] uppercase tracking-widest text-xs mb-4 block">
              ...
              <p className="text-white/70 font-light leading-relaxed mb-8">
                Mais do que páginas impressas, entregamos um objeto de afeto e
                alta qualidade estética que atravessa gerações na sua família.
              </p>

              <WhatsAppLink
                href={getWhatsAppUrl(
                  "Olá! Quero conversar sobre como transformar minha história em livro.",
                  "book_highlight"
                )}
        ...
        {/* 4. PROVA SOCIAL ANTECIPADA */}
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <span className="text-[#B87333] text-xs uppercase tracking-[0.2em]">
              Histórias Reais
            </span>
            <h2 className="font-serif text-3xl md:text-4xl font-light mt-3">
              Vidas reais. Livros reais.
            </h2>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-neutral-900/50 border border-[#B87333]/20 p-8 md:p-14 text-center">
            ...
            <p className="text-[#FDFBF7]/90 text-lg md:text-xl leading-relaxed italic font-serif mb-6">
              "Esse projeto é sensacional porque ele não apenas relata
              acontecimentos, mas acompanha a transformação de uma pessoa ao
              longo da vida... O livro deixa de ser apenas uma autobiografia e
              passa a ser uma obra sobre sobrevivência, traumas, recomeço e,
              acima de tudo, sobre reconhecer o que nos faltou na infância
              para oferecermos algo diferente à geração seguinte."
            </p>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="text-white/70 text-lg leading-loose space-y-4 font-light">
              ...
              <p className="text-white/40 italic pt-2">
                Mas memória também pode desaparecer.
              </p>
            </div>
        ...
        <section className="py-24 px-6 border-t border-white/5 bg-neutral-950">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-light mb-10">
              Por que registrar sua história agora?
            </h2>
            ...
            <div className="text-white/70 text-lg leading-relaxed font-light space-y-4 mb-10 text-left md:text-center">
              ...
              <p className="text-white font-medium">
                E aquilo que parece impossível esquecer hoje pode ser justamente
                o que seus filhos e netos mais desejarão conhecer amanhã.
              </p>
            </div>
            ...
            <WhatsAppLink
              href={getWhatsAppUrl(
                "Olá! Quero começar agora a registrar minha história.",
                "why_now"
              )}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="font-serif text-3xl md:text-4xl font-light mb-4">
                Não é simplesmente escrever uma autobiografia.
              </h2>

              <p className="text-white/60 font-light max-w-xl mx-auto">
                Uma autobiografia pode registrar acontecimentos. Nós queremos
                registrar a pessoa por trás deles.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-neutral-900/30 border border-white/5 p-8">
                <span className="text-white/30 text-xs uppercase tracking-widest block mb-4">
                  Autobiografia Tradicional
                </span>
              ...
              <div className="bg-[#B87333]/10 border border-[#B87333]/40 p-8">
                <span className="text-[#B87333] text-xs uppercase tracking-widest block mb-4 font-semibold">
                  Sua Vida em um Livro™
                </span>
            ...
            <p className="text-center text-white/60 font-serif italic mt-12 text-lg">
              Não queremos apenas saber o que aconteceu. Queremos entender o
              que aquilo significou para você.
            </p>
          </div>
        </section>
        ...
        <section
          id="como-funciona"
          className="py-24 px-6 bg-neutral-900/20 border-t border-white/5"
        >
              ...
              {[
                {
                  step: "01",
                  title: "Conversa",
                  desc: "Começamos ouvindo você e entendendo seu objetivo.",
                },
                {
                  step: "02",
                  title: "Entrevista",
                  desc: "Exploramos os momentos importantes da sua trajetória.",
                },
                {
                  step: "03",
                  title: "Escrita",
                  desc: "Transformamos suas memórias em uma narrativa literária.",
                },
                {
                  step: "04",
                  title: "Revisão",
                  desc: "Você acompanha, ajusta e aprova todo o conteúdo.",
                },
                {
                  step: "05",
                  title: "Livro",
                  desc: "Sua história ganha forma e permanece impressa.",
                },
              ].map((item, i) => (
                <div key={i} className="relative group">
                  <span className="text-[#B87333]/20 text-6xl font-serif absolute -top-8 -left-4 z-0">
                    {item.step}
                  </span>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="border border-white/10 p-10 flex flex-col justify-between hover:border-[#B87333]/50 transition-colors">
                <div>
                  <h3 className="text-xl font-serif text-[#B87333] mb-4">
                    Sua Própria História
                  </h3>

                  <p className="text-white/60 font-light mb-8">
                    "Quero registrar minha trajetória, meus aprendizados e o
                ...
                <WhatsAppLink
                  href={getWhatsAppUrl(
                    "Olá! Conheci o Sua Vida em um Livro e quero transformar minha própria história em livro.",
                    "my_story"
                  )}
              ...
              <div className="border border-[#B87333]/40 bg-[#B87333]/5 p-10 flex flex-col justify-between transform md:-translate-y-4">
                <div>
                  ...
                  <p className="text-white/80 font-light mb-8">
                    "Quero preservar a trajetória de quem veio antes de mim e
                    me deu a base de tudo."
                  </p>
                </div>

                <WhatsAppLink
                  href={getWhatsAppUrl(
                    "Olá! Quero saber como transformar a história dos meus pais em um livro.",
                    "parents_story"
                  )}
              ...
              <div className="border border-white/10 p-10 flex flex-col justify-between hover:border-[#B87333]/50 transition-colors">
                <div>
                  ...
                  <p className="text-white/60 font-light mb-8">
                    "Quero reunir memórias e conectar gerações em uma única
                    obra monumental."
                  </p>
                </div>
                ...
                <WhatsAppLink
                  href={getWhatsAppUrl(
                    "Olá! Quero saber como criar um livro com a história da minha família.",
                    "family_story"
                  )}
        ...
        <section
          id="formatos"
          className="py-24 px-6 border-t border-white/5 bg-neutral-950"
        >
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="font-serif text-3xl md:text-4xl font-light mt-4">
                Formatos de Projeto
              </h2>

              <p className="text-white/60 mt-4 text-lg">
                Projetos personalizados a partir de{" "}
                <strong className="text-white">R$ 1.990</strong>
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  title: "Registro",
                  desc: "Para preservar a história de forma mais direta e objetiva.",
                  msg: "Registro",
                },
                {
                  title: "Memórias",
                  desc: "Para uma narrativa biográfica mais profunda e detalhada.",
                  msg: "Memórias",
                  highlight: true,
                },
                {
                  title: "Legado",
                  desc: "Para uma experiência completa de preservação com alto requinte.",
                  msg: "Legado",
                },
                {
                  title: "Obra da Família",
                  desc: "Para unir diferentes gerações em um único volume.",
                  msg: "a Obra da Família",
                },
                {
                  title: "Colecionador",
                  desc: "Para projetos com acabamentos físicos e editoriais premium.",
                  msg: "Colecionador",
                },
                {
                  title: "Empresarial",
                  desc: "Para empresas, fundadores e memória institucional.",
                  msg: "Empresarial",
                },
              ].map((fmt, i) => (
                <div
                ...
                >
                  ...
                  <div className="flex items-center justify-between border-t border-white/10 pt-4">
                    ...
                    <WhatsAppLink
                      href={getWhatsAppUrl(
                        `Olá! Quero conhecer o projeto ${fmt.msg}.`,
                        "projects"
                      )}
        ...
        <section className="py-20 px-6 border-t border-white/5 bg-neutral-900/20 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-white/60 font-light space-y-2 text-lg">
              ...
              <p className="text-white/90 font-medium mt-4 pt-4 border-t border-white/10">
                Nada é publicado sem sua aprovação final e sigilo absoluto.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="faq" className="py-24 px-6 border-t border-white/5">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                {
                  q: "Eu não sei escrever. Posso fazer?",
                  a: "Sim! Você não precisa saber escrever. Nós conduzimos entrevistas com você, gravamos as conversas e nossa equipe editorial transforma seus relatos em um texto literário, estruturado e envolvente.",
                },
                {
                  q: "Minha história é interessante o suficiente?",
                  a: "Toda vida tem valor, aprendizados e momentos únicos que merecem ser guardados para as próximas gerações. O livro é sobre o seu legado.",
                },
                {
                  q: "Vocês fazem as entrevistas?",
                  a: "Sim, realizamos entrevistas guiadas, humanizadas e pacientes para extrair suas memórias da forma mais natural possível.",
                },
                {
                  q: "Eu posso revisar o conteúdo?",
                  a: "Sim. Nenhuma obra é encaminhada para a gráfica sem a sua leitura, revisão rigorosa e aprovação formal de cada capítulo.",
                },
                {
                  q: "Quem decide o que será publicado?",
                  a: "Exclusivamente você. Você tem total controle sobre o conteúdo da obra.",
                },
                {
                  q: "A história fica em sigilo?",
                  a: "Totalmente. Trabalhamos com cláusulas de confidencialidade estritas. A história é sua e só será lida por quem você permitir.",
                },
                {
                  q: "Posso fazer para meus pais ou avós?",
                  a: "Sim! É um dos projetos mais procurados e emocionantes. Conduzimos as entrevistas com eles com todo o cuidado.",
                },
                {
                  q: "Quanto custa e como começo?",
                  a: "Temos projetos a partir de R$ 1.990, variando conforme o escopo. Comece falando conosco pelo WhatsApp para encontrarmos o formato ideal.",
                },
              ].map((faq, i) => (
                <details
                  key={i}
                  className="group bg-neutral-900/30 border border-white/10 p-6 [&_summary::-webkit-details-marker]:hidden cursor-pointer"
                  data-event="faq_open"
                >
                  <summary className="flex items-center justify-between text-lg font-serif text-white/90 font-light">
                    {faq.q}

                    <span className="text-[#B87333] group-open:rotate-45 transition-transform text-2xl font-sans leading-none">
                      +
                    </span>
                  </summary>
            ...
            <div className="text-center mt-12">
              <WhatsAppLink
                href={getWhatsAppUrl(
                  "Olá! Tenho algumas dúvidas e gostaria de conversar.",
                  "faq"
                )}
                data-event="faq_whatsapp_click"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <section className="py-32 px-6 bg-gradient-to-b from-[#0a0a0a] to-neutral-900 text-center border-t border-white/5">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-serif text-4xl md:text-5xl font-light mb-6">
              Algumas histórias não deveriam desaparecer.
            </h2>

            <p className="text-white/60 text-lg font-light mb-12 max-w-2xl mx-auto">
              Você pode continuar carregando essa história apenas na memória.
              Ou pode deixá-la registrada para quem vier depois.
            </p>
            ...
            <p className="text-white/30 text-xs uppercase tracking-widest mt-4">
              Fale conosco pelo WhatsApp. Comece com uma conversa.
            </p>
          </div>
        </section>
      </main>
      ...
      <WhatsAppLink
        href={getWhatsAppUrl(
          "Olá! Estava navegando na página e gostaria de falar sobre minha história.",
          "floating"
        )}
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full bg-[#111] border-t border-white/10 p-4 z-50 flex items-center justify-between">
        ...
        <WhatsAppLink
          href={getWhatsAppUrl(
            "Olá! Quero saber como transformar minha história em um livro.",
            "mobile_bar"
          )}
